        ...
        connection.query(queryVenta, valuesVenta, (error, resultsVenta) => {
            if (error) {
                ...
                for (const detalle of detallesVenta) {
                    console.log('Valor de productoID al llegar al servidorrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr:', detalle.IDProducto); // Agregar esta línea
